...
/**
 * Home page - Sign in page for unauthenticated users
 */
      ...
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sign in with your Google account to access Drive, Calendar, and Gmail
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="mt-8 text-sm text-gray-600">
            <p className="font-semibold mb-2">This app will access:</p>
            <ul className="list-disc list-inside space-y-1 text-sm">
              <li>Your Google Drive files</li>
              <li>Your Google Calendar events</li>
              <li>Your Gmail messages (read-only)</li>
